...
export const getTouchTarget = (e: TouchEvent): Touch | null => {
...
export const parsePlayList = (
  src: string | MediaSource | SourceOption | any | (string | MediaSource | SourceOption | any)[] | (string | SourceOption | MediaSource | any)[][]
): (MediaSource | SourceOption)[][] => {
  if (!src) return [[]];
